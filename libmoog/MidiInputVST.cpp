...
Output * MidiInput::getOutput(const char *n)
{
...
void MidiInput::doNoteOff(unsigned int c, unsigned int n, unsigned int v)
{
    if (isUniSono == true)
    {
        allNotesOff();
...
void MidiInput::doPitchBend(unsigned int amount)
{
