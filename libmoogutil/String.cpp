...
//RCSID("$Id: String.cpp,v 1.5 2004/03/31 12:01:19 brainslayer Exp $");
...
int String::readLine(istream *istr)
{
	int retval;
	int c;
...
int String::write(ostream *ostr) const
{
	return ostr->write(DATA, LEN).eof();
}

int String::write(ostream *ostr, int start, int howMany) const
{
