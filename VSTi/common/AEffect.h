...
struct AEffect
{
	...
	long  (VSTCALLBACK * __cdecl dispatcher)(AEffect *effect, long opCode, long index, long value,
		void *ptr, float opt);
	
	void  (VSTCALLBACK * __cdecl process)(AEffect *effect, float **inputs, float **outputs, long sampleframes);
	
	void  (VSTCALLBACK * __cdecl setParameter)(AEffect *effect, long index, float parameter);
	float (VSTCALLBACK * __cdecl getParameter)(AEffect *effect, long index);
	...
	void (VSTCALLBACK *__cdecl processReplacing)(AEffect *effect, float **inputs, float **outputs, long sampleframes);
