...
Editor::Editor(Scheduler *sched, ConnectionManager *conn,AudioEffect *effect, Control *cntrl, MidiInput *midiinput): 
...
float Editor::getParameter(long index)
{
    if (control)
    {
...
void Editor::valueChanged(CDrawContext *canvas, CControl *ccontrol)
{
...
void Editor::addSlider(int x, int y, char *outputName)
{
...
void Editor::addButton(int x, int y, int bmp, char *outputName)
{
...
void Editor::addTwoSwitch(int x, int y, char *outputName)
{
...
void Editor::addThreeSwitch(int x, int y, char *outputName)
{
...
void Editor::addKey(int x, int y, int key, int bmp)
{
...
void Editor::addKnob(int x, int y, char *outputName)
{
...
void Editor::addKickButton(int x, int y, int bmp, char *outputName)
{
    CBitmap *bitmap = new CBitmap(bmp);
